...
namespace SimpleCalculator
{
	...
	public class CalcUI : System.Windows.Forms.Form
	{
        ...
        private string FactorialLoad(double value)
        {
            ...
            RichTextBox_OutPutFactorial.Invoke(PrintDlegateFunc, new object[] { $"‘‡ÍÚÓË‡Î ˜ËÒÎ‡ {TextBox_InputFactorial.Text} ‡‚ÂÌ:\n{numHold}" });
            ...
            return $"‘‡ÍÚÓË‡Î ˜ËÒÎ‡ {TextBox_InputFactorial.Text} ‡‚ÂÌ:\n{numHold}";
        }   
    }
}
