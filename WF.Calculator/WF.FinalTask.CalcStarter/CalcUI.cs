...
namespace SimpleCalculator
{
	...
	public class CalcUI : System.Windows.Forms.Form
	{
        ...
        private ToolStripMenuItem ìåíþToolStripMenuItem;
		...
		private void InitializeComponent()
		{
            ...
            this.ìåíþToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            ...
            // 
            this.ìåíþToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.ToolStripMenuItemClear,
            this.ToolStripMenuItemExit});
            this.ìåíþToolStripMenuItem.Name = "ìåíþToolStripMenuItem";
            this.ìåíþToolStripMenuItem.Size = new System.Drawing.Size(53, 20);
            this.ìåíþToolStripMenuItem.Text = "Ìåíþ";
            // 
            ...
            this.ToolStripMenuItemEngineering.Text = "Èíæèíåðíûé";
            ...
            this.groupBox1.Text = "Ôàêòîðèàë ÷èñëà:";
            // 
            ...
            this.Button_Factorial.Text = "Ïîñ÷èòàòü ôàêòîðèàë";
        ...
        private void CalcUI_Load(object sender, EventArgs e)
        {
            ...
            t1.SetToolTip(KeyZero, "Íîëü"); 
            t1.SetToolTip(KeyOne, "Îäèí");
            t1.SetToolTip(KeyTwo, "Äâà");
            t1.SetToolTip(KeyThree, "Òðè");
            t1.SetToolTip(KeySqrtY, "Êóáè÷åñêèé êîðåíü");
            t1.SetToolTip(KeySqrt, "Êâàäðàòíûé êîðåíü"); 
            t1.SetToolTip(KeySqrtEquation, "Êâàäðàòíîå óðàâíåíèå");
            t1.SetToolTip(KeySix, "Øåñòü");
            t1.SetToolTip(KeySign, "Îòðèöàòåëüíîå çíà÷åíèå"); 
            t1.SetToolTip(KeySeven, "Ñåìü");
            t1.SetToolTip(KeyReverse, "Ïåðåâåðíóòü äðîáü");
            t1.SetToolTip(KeyPowY, "×èñëî â ñòåïåíè");
            t1.SetToolTip(KeyPow, "Âîçâåñòè â êâàäðàòíóþ ñòåïåíü");
            t1.SetToolTip(KeyPoint, "Òî÷êà");
            t1.SetToolTip(KeyPlus, "Ñëîæèòü");
            t1.SetToolTip(KeyNine, "Äåâÿòü");
            t1.SetToolTip(KeyMultiply, "Óìíîæèòü");
            t1.SetToolTip(KeyMinus, "Âû÷åñòü");
            t1.SetToolTip(KeyFour, "×åòûðè"); 
            t1.SetToolTip(KeyFive, "Ïÿòü");
            t1.SetToolTip(KeyFactorial, "Ôàêòîðèàë");
            t1.SetToolTip(KeyEight, "Âîñåìü");
            t1.SetToolTip(KeyExit, "Âûõîä");
            t1.SetToolTip(KeyEqual, "Ðàâíî");
            t1.SetToolTip(KeyDivide, "Ðàçäåëèòü");
            t1.SetToolTip(KeyDate, "Äàòà");
            t1.SetToolTip(KeyClear, "Î÷èñòèòü");
        ...
        private void textBox1_KeyPress(object sender, KeyPressEventArgs e)
        {
             ...
             {
                e.Handled = true;
                errorProvider2.SetError(RichTextBox_OutPutFactorial, "Ìîæíî ââîäèòü òîëüêî öèôðû");
             }
            else
            {
        ...
        private void Button_Factorial_Click(object sender, EventArgs e)
        {
            ...
            RichTextBox_OutPutFactorial.Text = "Èäåò ðàñ÷åò ôàêòîðèàëà! (10s)";
